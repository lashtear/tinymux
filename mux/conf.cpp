...
void cf_init(void)
{
    ...
    mudconf.slave_path     = StringClone(T("libexec/slave"));
    mudconf.netmux_path    = StringClone(T("libexec/netmux"));
...
static CONFPARM conftable[] =
{
    ...
    {T("crash_message"),             cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.crash_msg,        NULL,       LBUF_SIZE},
    ...
    {T("down_motd_message"),         cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.downmotd_msg,     NULL,       LBUF_SIZE},
    ...
    {T("full_motd_message"),         cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.fullmotd_msg,     NULL,       LBUF_SIZE},
    ...
    {T("motd_message"),              cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.motd_msg,         NULL,       LBUF_SIZE},
    ...
    {T("slave_path"),                cf_string_dyn,  CA_STATIC, CA_GOD,      (int *)&mudconf.slave_path,      NULL, SIZEOF_PATHNAME},
    {T("netmux_path"),               cf_string_dyn,  CA_STATIC, CA_GOD,      (int *)&mudconf.netmux_path,     NULL, SIZEOF_PATHNAME},
    ...
    {T("pueblo_message"),            cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.pueblo_msg,       NULL,       LBUF_SIZE},
    ...
    {T("wizard_motd_message"),       cf_string,      CA_GOD,    CA_WIZARD,   (int *)mudconf.wizmotd_msg,      NULL,       LBUF_SIZE},
